<?php
  ...
  */
  ...
  define('REDIGIR_PATH',PLUGINDIR.'/redigir-net/');
  define('REDIGIR_VERSION','0.1');            
...
<?php  
  ...
  function redigir_main(){
      ...
      if ( $version != REDIGIR_VERSION ){
          $message = 'Existe uma versão mais recente deste plugin, para fazer download do mesmo basta consultar a <a title="Página de Downloads" target="_blank" href="http://redigir.net/home/downloads">página de downloads</a>.';
      }
?>
<div class="wrap">
